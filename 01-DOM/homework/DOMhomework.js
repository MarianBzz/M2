...
creador.innerHTML = 'Aplicación creada por Mariano';
...
function displayToDos() {
  ...
  let builded = buildToDos(toDoItems);
  for (let i = 0; i < builded.length; i++){
    toDoContainer.appendChild(builded[i]);
  }
...
// Tu código acá:
let event = document.querySelector('#addButton');
event.addEventListener('click', addToDo);
